                        ...
                        <thead class="table-light">
                            <tr>
                                <form action="{{ route('kapal.update', $kapal->id) }}" method="post">
                                    ...
                                    <input type="text" name="nama_pemilik" value="{{ $kapal->nama_pemilik }}" required>
                                    ...
                                    <input type="text" name="jenis_kapal" value="{{ $kapal->jenis_kapal }}" required>
                                
                                    <label for="ukuran">Ukuran</label>
                                    <input type="text" name="ukuran" value="{{ $kapal->ukuran }}" required>
